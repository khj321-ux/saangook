...
const renderers = {
  home() {
    main.innerHTML = `<section class="hero"><div class="container hero-grid"><div class="hero-copy"><p class="eyebrow">HUMANITIES · CULTURE · COMMUNITY</p><h1>생각이 머물고,<br><span>대화가 시작되는 곳</span></h1><p class="lead">${site.description} 공간명과 소개 문구는 현재 placeholder입니다.</p><div class="button-row"><a class="button" href="programs.html">프로그램 보기</a><a class="button button--outline" href="space.html">공간 둘러보기</a></div></div><div class="hero-art" role="img" aria-label="공간 대표 사진 placeholder"><span class="hero-mark"></span><span class="hero-line"></span></div></div></section>
