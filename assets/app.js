...
document.body.insertAdjacentHTML("afterbegin", `
  ...
  <header class="site-header">
    <div class="container header-inner">
      <a class="brand" href="index.html">${site.name}<small>HUMANITIES & CULTURE</small></a>
...
const renderers = {
  home() {
    main.innerHTML = `<section class="hero"><div class="container hero-grid"><div class="hero-copy"><h1><span class="hero-title-line">생각이 머물고,</span><span class="hero-title-line accent">대화가 시작되는 곳</span></h1><p class="lead">${site.description} 공간명과 소개 문구는 현재 placeholder입니다.</p><div class="button-row"><a class="button" href="programs.html">프로그램 보기</a><a class="button button--outline" href="space.html">공간 둘러보기</a></div></div><div class="hero-art" role="img" aria-label="공간 대표 사진 placeholder"><span class="hero-mark"></span><span class="hero-line"></span></div></div></section>
